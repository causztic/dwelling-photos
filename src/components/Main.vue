      ...
      default: () => (
        {
          'dc': [
            ...
            '',
            '',
            'There seems to be some form of conflict of interest: the estates are not only treated as preservation sites, but also being commercialized by being put up for sale. By subjecting the buildings as private commodities, this was at odds with the preservation status of being a national or public good, which was described by URA to “retain the inherent spirit and original ambience of historic buildings”, and requiring “an appreciation and understanding of the architecture and structure of historic buildings” - the former part felt wanting with the commercialization. ',
            '',
