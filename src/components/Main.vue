      ...
      default: () => (
        {
          'dc': [
            ...
            'The other courtyard that is not slated for preservation. It lies unkempt, but we still noticed a family coming over to play badminton after we were done photographing the area. <br/><br/>From Maurice Halbwach’s La Mémoire collective, besides having individual memory, a society can have a collective memory. This means that the individual is able to adopt the collective memory created by the environment he/ she lives in.',
            ...
            'Different types of window installations can be seen here. We can also see the zinc plating under the bamboo pole holders, which is not found in HDB flats as they tend to corrode easily. <br/> However, it was prime material back then as it was considerably cheaper than steel.',
            ...
            '(Scrollable) The stairwell of one of the buildings slated for preservation. As Dakota Crescent is near the central area of Singapore, it seems that the conservation status of these areas pushes up their demand even further. It makes these housing estates to be of higher value in terms of price and also social status. Of course, real-estate agents will not leave out these reasons when selling these houses to clients. Some people might not be buying these houses due to the “right reason”, which is to conserve them.<br/><blockquote>“Some homebuyers could also be drawn to the area due to fond memories of growing up there” - ERA (a real-estate company) key executive officer Eugene Lim</blockquote>',
          ...
          'tb': [
            '(Scrollable) Tiong Bahru is famous to tourists and Singaporeans alike for shophouses that sell exquisite products that may not be found elsewhere in Singapore.<br/><br/> It can be said that commercialisation for tourism can be due to “pragmatic economic reasons” as it brings about revenue for the country. That said, it can also mean that the preservation is due to the exploitation of local features of historical, cultural and scenic interest.',
            ...
            'Tourists roaming around the area was a common sight, sporting sleeveless attires due to the hot and humid weather in Singapore.<br/><br/>The treatment of landmarks as being heritage sites is often done by the process of Museumification. As a result, much of the site might become fake and man-made/ mock-ups. As such, it might not be as full of the vibrant life in the history it actually aimed to depict. For the SIT flats, the impact seems quite minimal. In Tiong Bahru, only a small area is being repurposed for businesses, restaurants and cafes. It is only in these places that we can argue that much of the setting is highly artificial, preservation with commercial utility.',
            '(Scrollable) One of the remaining SIT flats. Residents on the upper floors redesigned the windows, while the ones on the ground floor remained unchanged. This creates a dissonance in the overall aesthetics of the building. <br/> <br/> Most of Tiong Bahru is actually kept intact, remaining as housing estates. There are still many people living in these flats, especially elderly residents, so it does not seemed to be museumified at this very moment.',
            ...
            'A single road separates condominiums (left), HDB Flats (center) as well as SIT flats (right).<br/><br/><b>Is it necessarily a bad thing that the flats are preserved because of commercial reasons?</b>',
            ...
            'Apartments in a flat separated by a single staircase that could barely fit 2 people width-wise. We could hear the racket caused by the families with small children as we took this photo.<br/><br/>Even if the sustenance of preservation efforts are driven by economic reasons, we cannot simply deny that there may be some positive aspects to it. The act of preservation allows for a sense of national identity and an avenue of nostalgia as discussed in the earlier parts. The crucial thing is that some form of “genuine love” for the historic past of the SIT flats needs to exist in their management in the long run, otherwise the flats will just eventually become an artificial entity that acts as merely a money-making machine.',
            '(Scrollable) A landmark in SIT flats - the spiral staircase leads directly to the entrances of the apartments, although some seemed to be boarded up for good<br/><br/><b>Then, why are some of the SIT flats being torn down?</b><blockquote>“This popular acceptance of ‘survival through pragmatism’ is primarily grounded in the tangible results of the ‘practical’ policies of the government: that is, the policies have ‘delivered the goods’. Any social repression that attends these policies is seen as politically essential to continuing economic growth; this is the bargain the electorate makes with the PAP government.” - Chua B.H, Political Legitimacy and Housing: Stakeholding in Singapore</blockquote>',
            ...
            'The reconstructed Community Centre. It was originally built to host activities to promote kinship among neighbours. <br/><br/>The flats nearby are promoted as heritage sites with even “Heritage Trails” that one can follow by finding information boards situated beside key landmarks.',
